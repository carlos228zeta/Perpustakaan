...
<div class="stat-grid">
    <div class="stat-card">
        <div>
            ...
            <div style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.25rem;">Batas Maksimal: 5 Buku</div>
        </div>
    ...
    <div class="stat-card">
        <div>
            ...
            <div style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.25rem;">Menunggu Ketersediaan</div>
        </div>
...
<div class="card-tzuchi">
    <div class="card-header-tzuchi">
        ...
        <a href="{{ route('public.books.index') }}" class="btn-tzuchi btn-primary-tzuchi btn-sm"><i class="bi bi-search"></i> Cari Buku Lagi</a>
    </div>
