...
@section('header_title', 'Dashboard Pendidik — ' . auth()->user()->name)
...
<div class="card-tzuchi">
    <div class="card-header-tzuchi">
        <div>
            ...
            <div style="font-size: 0.775rem; color: var(--text-muted);">Daftar koleksi buku yang sedang Anda pinjam</div>
        </div>
