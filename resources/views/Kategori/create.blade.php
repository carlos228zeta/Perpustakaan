...
@section('header_title', 'Tambah Kategori Buku')
...
<div style="max-width: 600px; margin: 0 auto;">
    <div class="card-tzuchi">
        <div class="card-header-tzuchi">
            <div>
                <h3 style="font-size: 1.1rem; margin-bottom: 0.2rem;">Form Kategori Baru</h3>
                <div style="font-size: 0.825rem; color: var(--text-muted);">Tambah kategori baru ke sistem.</div>
            </div>
        ...
        <form action="{{ route('kategori.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="form-control-tzuchi" required placeholder="Contoh: Pemrograman">
            </div>

            <div class="form-group">
                <label class="form-label">Deskripsi</label>
                <textarea name="description" rows="3" class="form-control-tzuchi" placeholder="Penjelasan bidang kategori...">{{ old('description') }}</textarea>
            </div>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 0.75rem; border-top: 1px solid var(--border-color); padding-top: 1.25rem;">
                ...
                <button type="submit" class="btn-tzuchi btn-primary-tzuchi"><i class="bi bi-check-lg"></i> Simpan Kategori</button>
            </div>
        </form>
    </div>
</div>
