    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4" style="background-color: #ffffff;">
            <div class="card-header bg-white py-4 d-flex align-items-center border-bottom" style="border-bottom-color: #f1f5f9 !important;">
                <a href="{{ url('/admin/siswa') }}" class="btn btn-sm btn-light text-muted me-3 border-0" style="background: #f8fafc;">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div>
                    <h5 class="mb-1 fw-bold text-dark" style="font-size: 1.1rem;">Profil Siswa</h5>
                    <p class="text-muted mb-0" style="font-size: 0.85rem;">Detail informasi anggota siswa perpustakaan.</p>
                </div>
            </div>
